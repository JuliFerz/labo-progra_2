namespace Delegado
{
    partial class FrmPrincipal
    {
        ...
        private void InitializeComponent()
        {
            ...
            menuAlta = new ContextMenuStrip(components);
            testDelegadoToolStripMenuItem = new ToolStripMenuItem();
            alumnoToolStripMenuItem = new ToolStripMenuItem();
            menuAlta.SuspendLayout();
            SuspendLayout();
            // 
            // menuAlta
            // 
            menuAlta.Items.AddRange(new ToolStripItem[] { testDelegadoToolStripMenuItem, alumnoToolStripMenuItem });
            menuAlta.Name = "menuAlta";
            menuAlta.Size = new Size(181, 70);
            menuAlta.Text = "Menu";
            // 
            ...
            menuAlta.ResumeLayout(false);
            ResumeLayout(false);
        }

        #endregion

        private ContextMenuStrip menuAlta;
