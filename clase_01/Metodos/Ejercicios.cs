    ...
    public class Ejercicios
    {
        ...
        public static void Ejercicio_09()
        {
            ...
            if (height > 0)
            {
                ...
                {
                    //String piramid = new String(piramidIcon, 1 * row) + (row > 1 ? piramidIcon : "");
                    String piramid = new String(piramidIcon, 1 * row);
                    //piramid = row > 1 ? piramid.PadRight(piramid.Length + 2, piramidIcon) : "";
                    piramid = row > 1 ? piramid.PadRight(piramid.Length + 1, piramidIcon) : "";
        ...
        public static void Ejercicio_10()
        {
            ...
            if (height > 0)
            {
                ...
                {
                    String piramid = new String(piramidIcon, 1 * row) + (row > 1 ? piramidIcon : "");
                    Console.WriteLine(piramid.PadLeft(padString));
                    //padString--;
                    //Console.WriteLine(piramid);
                }
            }
